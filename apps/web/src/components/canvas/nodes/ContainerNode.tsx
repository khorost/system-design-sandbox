...
export function ContainerNode(props: NodeProps<ComponentNode>) {
  ...
  const boxShadow = selected
    ...
    : isDragBlocked
      ...
      : isDragSource
        ...
        : is3d
          ? `0 ${ISO_DEPTH.container.y + 4}px 22px rgba(3,8,14,0.30), inset 0 0 0 1px rgba(255,255,255,0.02)`
  ...
  return (
    <IsoShell
      ...
      depth={ISO_DEPTH.container}
      wrapperClassName="w-full h-full rounded-lg relative overflow-visible"
      wrapperStyle={is3d ? { transform: 'translateZ(4px)' } : undefined}
      frontClassName="w-full h-full rounded-lg relative overflow-hidden"
      frontStyle={{
        background: is3d
