      ...
      <div className="px-3 py-3 border-b border-[var(--color-border)]">
        ...
        <div className="relative mt-2">
          <input
            ...
            className="w-full px-3 py-1.5 pl-8 text-sm bg-[var(--color-bg)] border border-[var(--color-border)] rounded-md text-slate-200 placeholder:text-slate-400 focus:outline-none focus:border-blue-500 transition-colors"
          />
